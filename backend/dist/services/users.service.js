...
var UserService = /*#__PURE__*/ function() {
    ...
    _proto.findAllUser = function findAllUser() {
        var _this = this;
    ...
    _proto.findUserById = function findUserById(userId) {
        var _this = this;
        return _asyncToGenerator(function() {
            var findUser;
            return __generator(this, function(_state) {
    ...
    _proto.createUser = function createUser(userData) {
        var _this = this;
        return _asyncToGenerator(function() {
    ...
    _proto.updateUser = function updateUser(userId, userData) {
        var _this = this;
        return _asyncToGenerator(function() {
            ...
            return __generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 1:
                        findUser = _state.sent();
                        if (findUser && findUser.id != userId) throw new HttpException(409, "This email ".concat(userData.email, " already exists"));
                        _state.label = 2;
                    case 2:
    ...
    _proto.deleteUser = function deleteUser(userId) {
        var _this = this;
        return _asyncToGenerator(function() {
            var deleteUserById;
            return __generator(this, function(_state) {
